...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Kelola Kategori Artikel SDN Pabelan 01</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<form role="form" name="input" action="<?php $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
            <input type="submit" name="input" class="btn btn-default" value="Input Kategori Artikel"><br><br>
            </form>
            <?php
            error_reporting(E_ALL ^ E_NOTICE ^ E_DEPRECATED);
            $input=$_POST['input'];
            if ($input) {
                ?>
                <script>
                    document.location="input_kategori.php";
                </script>
            <?php
            }
            ?>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                while ($data=mysqli_fetch_array($run)) {
                                    ...
                                    <tr class='odd gradeX' id='tabel'>
                                        ...
                                        <td class='center'><a href='kategori_edit.php?upd=$data[id_kategori]'><i class='fa fa-pencil fa-fw'></i></a></td>
                                        <td class='center'><a href='del_kategori.php?del=$data[id_kategori]'><i class='fa fa-trash-o fa-fw'></i></a></td>
                                    </tr>
                                    ";
                                    $no++;
                                }
