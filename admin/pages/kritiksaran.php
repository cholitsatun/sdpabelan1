    ...
    <div id="wrapper">
       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Kritik dan Saran</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    include "koneksi.php";
                                    $no=1;
                                    $sql="select * from komentar order by tgl DESC";
                                    ...
                                    <tr class='odd gradeX'>
                                        ...
                                        <td>$data[nama]</td>
                                        <td>$data[email]</td>
                                        <td class='center'>$data[isi]</td>
										<td class='center'>$data[tgl]</td>
                                        <td class='center'><a href='del_komen.php?del=$data[id_komen]'><i class='fa fa-trash-o fa-fw'></i></a></td>
                                    </tr>
                                    ";
                                    $no++;
                                }
